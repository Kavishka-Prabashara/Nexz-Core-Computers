...
const SideBar = () => {
    ...
    return (
        <>
            ...
            <div className="fixed top-20 left-4 md:hidden z-20">
                <button
            ...
            {/* Sidebar */}
            <aside
                className={`bg-black w-64 p-4 shadow-lg absolute top-0 left-0 h-full z-50 transition-transform transform ${
